export const questionsData = [
    ...
    {
        "id": "q222_topic1",
        "text": "Em um Model-driven App, você deseja incorporar uma experiência de arrastar e soltar (Drag-and-Drop) de forma livre, sem depender de um formulário de tabela específico. Qual a solução recomendada?",
        "options": [
            "Criar uma Página Personalizada (Custom Page) e adicioná-la ao Sitemap.",
            "Embutir um Canvas App dentro de um Formulário Principal.",
            "Utilizar um IFrame nativo no Painel Principal.",
            "Criar um Web Resource do tipo HTML."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Diferencia formas de incorporar telas em Model-driven apps.",
            "papoReto": "Se você quer total liberdade e não quer ficar preso a um formulário, a Custom Page é a resposta. Canvas App embutido precisa de uma tabela e um formulário para viver.",
            "respostaCerta": "Criar uma Página Personalizada (Custom Page) e adicioná-la ao Sitemap.",
            "puloDoGato": "Custom Pages convergem os Canvas apps no Model-driven de forma autônoma, inserindo-as diretamente no Sitemap sem necessidade de Dataverse forms.",
            "cascasDeBanana": [
                "Embutir um Canvas App exige o contexto de um Form Principal e de um registro."
            ],
            "dicaOuro": "Livre e sem Formulário = Custom Page no Sitemap!"
        }
    },
    {
        "id": "q223_topic1",
        "text": "Você criou um Canvas app consumindo dados de uma planilha Excel no OneDrive for Business. O que é necessário para que sua equipe também acesse esses dados pelo App?",
        "options": [
            "Compartilhar apenas o Canvas App com a equipe.",
            "Compartilhar manualmente a planilha Excel no OneDrive com a equipe.",
            "Exportar o App como Solução.",
            "Nenhuma ação, o Power Apps herda as permissões do proprietário do App."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Permissões de fontes de dados externas em Canvas Apps.",
            "papoReto": "Compartilhar o App não compartilha automaticamente as fontes que não são do Dataverse. Se o arquivo está no seu OneDrive, você tem que ir lá e liberar o acesso pra eles na mão.",
            "respostaCerta": "Compartilhar manualmente a planilha Excel no OneDrive com a equipe.",
            "puloDoGato": "Conectores padrão (Excel, OneDrive, SharePoint) requerem que a permissão seja concedida explicitamente no nível da plataforma de origem do dado.",
            "cascasDeBanana": [
                "Achar que o Power Apps distribui o acesso do arquivo do OneDrive automaticamente ao compartilhar a tela."
            ],
            "dicaOuro": "OneDrive e Excel no App? Não basta dar acesso ao App, tem que dar acesso ao Excel!"
        }
    },
    {
        "id": "q224_topic1",
        "text": "Um chatbot do Power Virtual Agents (PVA) precisa validar no Dataverse se um CEP existe antes de avançar. Como o PVA executa essa validação em banco de dados externo?",
        "options": [
            "Usando as Business Rules do Dataverse.",
            "Chamando uma Ação que executa um Power Automate Cloud Flow.",
            "Instalando um Webhook no portal.",
            "Rodando um script JavaScript no nó de mensagem."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Interoperabilidade entre PVA e a Power Platform.",
            "papoReto": "O Bot do PVA não lê banco de dados sozinho. Ele precisa chamar um fluxo do Power Automate para ir até o Dataverse, pesquisar o CEP, e devolver a resposta pra ele.",
            "respostaCerta": "Chamando uma Ação que executa um Power Automate Cloud Flow.",
            "puloDoGato": "O nó 'Call an Action' invoca Cloud Flows projetados para retornar variáveis escalares de volta ao tópico do PVA.",
            "cascasDeBanana": [
                "Business rules rodam APENAS em formulários Model-driven ou backend do Dataverse, nunca dentro da tela do Chatbot."
            ],
            "dicaOuro": "PVA interagindo com dados reais (CRUD)? A resposta é sempre: Power Automate Cloud Flow!"
        }
    },
    {
        "id": "q225_topic1",
        "text": "No App Checker (Verificador de Aplicativo) do Canvas Studio, qual dos itens abaixo NÃO é avaliado como uma categoria formal de verificação?",
        "options": [
            "Fórmulas (Erros de sintaxe).",
            "Acessibilidade (Compatibilidade com leitores de tela).",
            "Desempenho (Performance).",
            "Responsividade Automática de Interface (UI/UX)."
        ],
        "correctAnswer": 3,
        "explanation": {
            "intro": "Conhecimento sobre os limites do App Checker.",
            "papoReto": "O App Checker testa código, acessibilidade para deficientes visuais e lentidão de performance. Beleza, design e telas tortas não são problemas dele.",
            "respostaCerta": "Responsividade Automática de Interface (UI/UX).",
            "puloDoGato": "O App Checker não possui motor para analisar boas práticas de UI Design ou quebra de responsividade visual.",
            "cascasDeBanana": [
                "Muitos acham que acessibilidade não é checada, mas ela é a categoria com mais avisos no App Checker (ausência de Labels)."
            ],
            "dicaOuro": "O Checker verifica o 'motor' e a 'acessibilidade', NUNCA a 'beleza'!"
        }
    },
    {
        "id": "q226_topic1",
        "text": "O chatbot pergunta: 'Qual a sua idade?'. O usuário responde: 'Eu sou muito velho, tenho 65 anos'. Se a entidade extraída for a Prebuilt Entity 'Age' (Idade), o que será salvo na variável?",
        "options": [
            "A frase inteira: 'Eu sou muito velho, tenho 65 anos'.",
            "Apenas o número: 65.",
            "O bot falhará por excesso de palavras.",
            "Um array com cada palavra digitada."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Compreensão de IA e Entity Extraction no PVA.",
            "papoReto": "O robô é esperto! Quando ele usa a entidade 'Idade', ele ignora todo o bla-bla-bla do usuário e pesca apenas a idade do texto.",
            "respostaCerta": "Apenas o número: 65.",
            "puloDoGato": "Modelos Prebuilt (Idade, Cor, Dinheiro) efetuam o 'Slot-filling', pescando exclusivamente o dado primitivo solicitado dentro da frase inteira.",
            "cascasDeBanana": [
                "Salvar a frase inteira exige o uso explícito da Entidade 'Entire user response'."
            ],
            "dicaOuro": "Entidade Fechada (Idade, Cor) sempre ignora a enrolação do usuário!"
        }
    },
    {
        "id": "q227_topic1",
        "text": "Num Canvas app, você quer que um Botão fique 'cinza e desabilitado' até que a caixa de texto 'Nome' seja preenchida. Qual propriedade do Botão você deve alterar com um If(IsBlank(...)) ?",
        "options": [
            "Visible",
            "DisplayMode",
            "OnSelect",
        ...
        "correctAnswer": 1,
        "explanation": {
            "intro": "Controle de interface em Canvas Apps.",
            "papoReto": "Mudar para 'Cinza e Intocável' ou 'Clicável e Normal' é a propriedade Modo de Exibição (DisplayMode = Disabled ou Edit). A Visible faz o botão desaparecer completamente.",
            "respostaCerta": "DisplayMode",
            "puloDoGato": "A fórmula correta é If(IsBlank(Nome.Text), DisplayMode.Disabled, DisplayMode.Edit).",
            "cascasDeBanana": [
                "A propriedade EnabledState não existe nativamente com esse nome, usamos DisplayMode."
            ],
            "dicaOuro": "Desabilitar/Travar Botão sem fazê-lo sumir = DisplayMode.Disabled!"
        }
    },
    {
        "id": "q228_topic1",
        "text": "Você fez alterações no layout de um formulário Model-driven no ambiente de DEV. Para garantir que essas mudanças visuais subam no arquivo ZIP da Solução exportada, qual passo é obrigatório?",
        "options": [
            "Executar o Solution Checker.",
            "Publicar todas as Customizações (Publish All Customizations).",
            "Compartilhar a solução com a equipe.",
            "Aumentar a versão do aplicativo Canvas."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Ciclo de vida ALM básico de Soluções.",
            "papoReto": "Tudo que você muda na tela (Formulário, View) só vai parar dentro do ZIP da solução para produção se você avisar o servidor clicando em PUBLICAR primeiro.",
            "respostaCerta": "Publicar todas as Customizações (Publish All Customizations).",
            "puloDoGato": "Apenas metadados em estado 'Published' no Dataverse entram no pacote exportado de uma Solução.",
            "cascasDeBanana": [
                "O Solution checker valida a solução, mas NÃO publica o que está salvo em rascunho (Unpublished)."
            ],
            "dicaOuro": "Mudou a tela do Model-driven e vai exportar? Publique tudo antes!"
        }
    },
    {
        "id": "q229_topic1",
        "text": "Um processo de despesa exige que os Diretores A, B e C recebam um pedido de Aprovação. A despesa SÓ deve ser liberada se TODOS os 3 votarem Sim. Que tipo de Approval você deve usar no Power Automate?",
        "options": [
            "Approve/Reject - First to respond.",
            "Custom Responses - Wait for one response.",
            "Approve/Reject - Everyone must approve.",
            "Approval with Timeout Constraint."
        ],
        "correctAnswer": 2,
        "explanation": {
            "intro": "Tipos de Fluxo de Aprovação.",
            "papoReto": "Regra básica: 'Se todos têm que assinar, todos devem aprovar!'. Se o tipo fosse First to respond, a assinatura de apenas 1 Diretor já liberaria a grana.",
            "respostaCerta": "Approve/Reject - Everyone must approve.",
            "puloDoGato": "Ação base do Dataverse/Automate que faz Suspensão do Fluxo até 100% dos assinantes designados baterem o martelo de aprovação.",
            "cascasDeBanana": [
                "First to respond é o mais comum, mas inapropriado quando exige consenso unânime."
            ],
            "dicaOuro": "Consenso Fixo de todos = Everyone must approve!"
        }
    },
    {
        "id": "q230_topic1",
        "text": "Você tem PDFs de notas fiscais chegando por e-mail e precisa extrair o CNPJ e o 'Total a Pagar' para o Dataverse. Qual modelo do AI Builder é feito especificamente para essa tarefa?",
        "options": [
            ...
            "Receipt Scanning (Leitura Rápida Global)."
        ],
        "correctAnswer": 2,
        "explanation": {
            "intro": "Modelos do AI Builder abordados na PL-200.",
            "papoReto": "Sempre que for ler Faturas, recibos estruturados ou formulários preenchidos, o nome da máquina é 'Document Processing' (antigo form processing).",
            "respostaCerta": "Document Processing (Processamento de Documentos).",
            "puloDoGato": "O Document Processing extrai Key-Value pairs e Tabelas de layouts fixos pré-treinados a partir de 5 amostras.",
            "cascasDeBanana": [
                "A Entity Extraction tira dados de textos/parágrafos longos soltos, não de faturas PDF rígidas."
            ],
            "dicaOuro": "Ler Nota Fiscal, Fatura ou Layout Mapeado = Document Processing!"
        }
    },
    {
        "id": "q231_topic1",
        "text": "Sua Regra de Negócio (Business Rule) no Dynamics dita que: 'SE o campo Risco for Alto, oculte a Aba Auditoria'. Porém, não está funcionando. Você percebe que o campo Risco não foi adicionado fisicamente ao formulário. Por que falhou?",
        "options": [
            "Regras de Negócio exigem que todos os campos da condição IF estejam fisicamente no Formulário.",
            "A Regra de Negócio não pode esconder abas, apenas campos.",
            "A regra é executada no servidor, logo não manipula a UI.",
            "O escopo estava configurado como Entidade."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Limitações puristas do motor de Business Rules Client-Side.",
            "papoReto": "Se a Regra roda no seu Browser (Formulário), ela olha pro HTML. Se o campo Risco não tá lá (mesmo que oculto), ela bate a cabeça e morre. A condição precisa do campo na tela!",
            "respostaCerta": "Regras de Negócio exigem que todos os campos da condição IF estejam fisicamente no Formulário.",
            "puloDoGato": "Form-scoped Business Rules processam via Client-side. A engine lê a DOM para fazer o evaluate. Se o atributo não existe no DOM, ela aborta.",
            "cascasDeBanana": [
                "Regras DE FATO podem ocultar e mostrar abas. O problema é exclusivo da ausência do campo gatilho."
            ],
            "dicaOuro": "A regra não dispara a condicional de tela? Verifique se o campo do 'IF' não foi esquecido fora do Formulário!"
        }
    },
    {
        "id": "q232_topic1",
        "text": "Ao usar o nó 'Initialize Variable' (Inicializar Variável) dentro da ação 'Apply to each' num Cloud Flow, a ação aparece bloqueada ou dá erro. Qual a causa arquitetural?",
        "options": [
            "A variável precisa ser do tipo Booleana.",
            "Variáveis devem nascer (ser inicializadas) exclusivamente no Nível Raiz do Fluxo.",
            "Bug temporário no Flow Checker Maker.",
            "Loops não suportam Dataverse records."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Regras vitais de escopo no Power Automate.",
            "papoReto": "Nunca tente CRIAR uma variável dentro de um laço de repetição ou condição 'Se'. Elas devem nascer lá em cima, de forma Global. Só DEPOIS você pode usar 'Set Variable' lá nas profundezas do Loop.",
            "respostaCerta": "Variáveis devem ser inicializadas exclusivamente no Nível Raiz (Root) do Fluxo.",
            "puloDoGato": "Initialize Variable action só funciona no escopo Global Superior (Root level scope). Scopes aninhados requerem 'Set Variable' ou 'Append to Array'.",
            "cascasDeBanana": [
                "As pessoas tentam criar variáveis para servirem apenas a um IF. Não existe Variável Local no Automate, só Variável Global."
            ],
            "dicaOuro": "Botão Inicializar variável está cinza dentro do Else/If? Jogue a ação pra fora do If ali em cima no topo!"
        }
    },
    {
        "id": "q233_topic1",
        "text": "Um vendedor anexou PDFs a uma Oportunidade no Dynamics 365. O ambiente usa a integração 'OneDrive for Business'. Vendedores da mesma equipe reclamam que não conseguem abrir os PDFs. Por que isso ocorre?",
        "options": [
            "No OneDrive for Business integrado, arquivos são privados por default e o Vendedor precisa re-compartilhar manualmente.",
            "Existe um bug bloqueando extensões PDF.",
            "O Dynamics exige permissões de System Admin para ler arquivos de base.",
            "As Views de oportunidade ignoram subgrids do SharePoint nativamente."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Lógica de controle de acesso vs Armazenamento M365.",
            "papoReto": "A regra é forte: SharePoint é pasta compartihada com a galera. OneDrive é SUA gaveta pessoal. Se anexa no OneDrive e não dá 'Compartilhar' lá na nuvem Microsoft, ninguém do CRM vê!",
            "respostaCerta": "OneDrive for Business integrado é privado por padrão.",
            "puloDoGato": "Ao anexar, o documento vai para uma pasta oculta gerada no Workspace do Owner (dono). Role-Based Access do Dataverse NÃO reflete magicamente no RBAC do OneDrive.",
            "cascasDeBanana": [
                "Achar que quem tem acesso ao Registro no CRM ganha acesso ao Arquivo no OneDrive automaticamente (isso é verdade só no SharePoint)."
            ],
            "dicaOuro": "Integrou OneDrive em Oportunidade? Prepare-se pra compartilhar manualmente os arquivos MS."
        }
    },
    {
        "id": "q234_topic1",
    ...
    {
        "id": "q235_topic1",
        "text": "Carlos, o vendedor, acabou de fechar R$ 5.000 em vendas e deu um F5 na engrenagem de 'Goals' (Metas) do painel dele, mas a barrinha marcou zero vendas ainda. Qual é o motivo desse atraso?",
        "options": [
            "O cache nativo do navegador bloqueou a transação TCP.",
            "Goals usam o Job de Rollup Query que recalcula de forma assíncrona, nativamente a cada 24h.",
            "A licença Dynamics Sales Freezing exige fechamento mensal.",
            "Carlos usou moeda errada nas oportunidades."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Processamento Assíncrono de Metas do CRM.",
            "papoReto": "A maquininha que soma o dinheiro do mês do Vendedor só roda sozinha enquanto a fábrica dorme (a cada 24 horas via Servidor). Se ele quer ver no momento, ele tem que apertar o botão manual 'Recalcular'.",
            "respostaCerta": "Goals usam o Job de Rollup Query que recalcula assumidamente a cada 24h.",
            "puloDoGato": "O Asynchronous System Job: Goal Rollup ocorre para poupar processamento do banco. Não é síncrono. Disparar Recalculate faz on-demand execution.",
            "cascasDeBanana": [
                "A atualização de browser (F5) não provoca recalculo de base de dados complexos de Timeframe."
            ],
            "dicaOuro": "Barra de Meta não encheu na hora da Venda? É Rollup Time job! Manda ele apertar em 'Recalcular'."
        }
    },
    {
        "id": "q236_topic1",
        "text": "Você criou uma Tabela Customizada chamada 'Sorteios' do zero. Porém, ela não aparece na Global Search (A grande Lupa de busca unificada no topo do CRM). O que você deve fazer nas Propriedades da Tabela?",
        "options": [
            "Validar se a Role do usuário tem permissão para usar Lupas.",
            "Ativar opções 'Controlar Alterações' (Track Changes) e 'Aparecer nos Resultados de Pesquisa Global' (Enable Dataverse Search).",
            "Criar uma Business Rule visando o atributo Global Search.",
            "Migrar de Dataverse Clássico para Elastic Tables."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Requisitos de Indexação do Dataverse Search.",
            "papoReto": "Qualquer tabela que você cria solta no ar vem de fábrica 'bloqueada' pra Lupa da ferramenta. Você precisa abrir as configs dela e ligar as flags de Controlar Mudanças e Pesquisa para o Motor M365 enxergar.",
            "respostaCerta": "Ativar 'Controlar Alterações' (Track Changes) e 'Enable Dataverse Search'.",
            "puloDoGato": "A arquitetura do Dataverse Search (Azure Search engine) necessita do Track Changes enabled para indexar os dados incrementalmente antes de dispô-los nos outputs de Global Lupa.",
            "cascasDeBanana": [
                "Esquecer a Caixa Track Changes fará o Checkbox do Global Search dar erro ao publicar."
            ],
            "dicaOuro": "Tabela nova invisível na Pesquisa Principal? Ligar a Pesquisa e as Mudanças Controladas (Track Changes)!"
        }
    },
    {
        "id": "q237_topic1",
        "text": "Dentro do Power Automate para aprovações na organização, você necessita extrair o conteúdo do anexo do Flow para salvar uma cópia num Storage nativo. Que formato dinâmico o File Content retorna no Automate?",
        "options": [
            "Base64 string.",
            "XAML UI Element.",
            "Word Document Binário bruto limit.",
            "String Literal Text."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Tipos de Arquivos transitados no Automate.",
            "papoReto": "Seja enviar um PDF por e-mail ou salvar um logo do Planner, o Automate por trás dos panos lê esse arquivo como uma sopa de letrinhas ilegível chamada Base64.",
            "respostaCerta": "Base64 string.",
            "puloDoGato": "The core File Data in Cloud Flows are handled as binary content and usually translated via functions base64ToBinary() ou explicit Base64 streams.",
            "cascasDeBanana": [
                "Ele não pode ler XAML ou Word bruto, o fluxo trabalha com Arrays de Bytes estruturados."
            ],
            "dicaOuro": "Passou Anexo File de um lugar pro outro no Flow? É Base64 garantido!"
        }
    },
    {
        "id": "q238_topic1",
        "text": "No Maker Portal de Power Pages (Power Apps Portals), você precisa criar uma Página Privada acessível SOMENTE aos funcionários que fizerem Login. Qual o recurso primordial que liga um registro de Contato ao Portal limitando acesso?",
        "options": [
            "Page Templates.",
            "Liquid Tags.",
            "Web Roles.",
        ...
        "correctAnswer": 2,
        "explanation": {
            "intro": "Segurança de Autenticação Nativas do Power Pages.",
            "papoReto": "Em Power Pages, um Web Role é o super segurança da boate. O Contato entra, ganha a plaquinha 'Usuário Logado' (Web Role) e só com essa plaquinha ele acessa as Páginas da festa.",
            "respostaCerta": "Web Roles.",
            "puloDoGato": "Table Permissions e Page Access Control Rules only function against Contact records linked to designated Web Roles.",
            "cascasDeBanana": [
                "Liquid Tags fazem front-end binding e lógicas, não Authorization direta."
            ],
            "dicaOuro": "Controlar Acesso e Privilégio em Portais externos M365 = Web Roles."
        }
    },
    {
        "id": "q239_topic1",
        "text": "Seu Dashboard do Power BI possui o Row-level Security (RLS) implantado firmemente. Você compartilha este Dashboard com um Gerente de Vendas em um Workspace compartilhado no qual ele é dado como 'Member'. Qual o resultado do RLS para este cenário?",
        "options": [
            "Ele lerá somente as Vendas da filial dele.",
            "O RLS irá ignorá-lo e ele terá acesso liberado aos dados globais da empresa.",
            "O acesso dele será restrito e uma trava de Login exigirá Multi-Factor.",
            "Ele não conseguirá visualizar visuais nativos, apenas Paginated Reports."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Regras de Limite no RLS.",
            "papoReto": "O RLS (Segurança de Linha) é pra 'Viewer' (leitor)! Se você der poder de 'Member' (Membro), 'Admin' ou 'Contributor' pro cara dentro do Workspace, o Power BI diz: Ah, esse cara é chefinho e amigo do criador do relatório, desliga a segurança total pra ele ver tudo!",
            "respostaCerta": "O RLS irá ignorá-lo e ele terá acesso liberado aos dados globais.",
            "puloDoGato": "The Row-level Security filters are applied automatically to individuals with the 'Viewer' access role ONLY in a App/Workspace deployment limit.",
            "cascasDeBanana": [
                "Muitos acreditam que o RLS barra qualquer um, até Administradores. Mito. Roles Editoriais sobrepõe o RLS."
            ],
            "dicaOuro": "Quer RLS aplicando restrição pesada no cidadão? Coloque ele com Acesso Exclusivo a 'Visualizador' (Viewer)!"
        }
    },
    {
        "id": "q240_topic1",
        "text": "Onde ficam armazenados fisicamente de forma segura os Workflows complexos tipo Diálogo (Dialog) de versões ultrapassadas (Legacy) no Model-Driven se um admin precisar alterá-los hoje?",
        "options": [
            "Process (Processos)",
            "Power Automate Desktop",
            "Model-Driven Apps Views Settings",
            "App Source Marketplaces."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Tratamento de Legacy Workflows (Workflow Clássico do CRM).",
            "papoReto": "Fugiu do Power Automate e caiu num sistema da época das cavernas do Dynamics que usa Diálogos do servidor nativo? Isso vive esquecido numa gaveta do menu de 'Processos' nas configurações clássicas de negócios.",
            "respostaCerta": "Process (Processos) no background clássico.",
            "puloDoGato": "Background Workflows e Dialogs são geridos em Advance Settings -> Processes. A MS incentiva a conversão para Cloud Flows no Automate.",
            "cascasDeBanana": [
                "Power Automate Desktop substituiu fluxos de Desktop legados pesados, não os Processos do Dynamics em Nuvem."
            ],
            "dicaOuro": "Diálogos ou Workflows Workflow do Velho Dynamics? = Advanced Settings -> Processes!"
        }
    },
    {
        "id": "q241_topic1",
        "text": "Num formulário Model-driven, o controle Timer (Temporizador) falha e não muda as cores dependendo do atraso no SLA do caso. A equipe descobre que o relógio não exibe o Tempo Restante real do Acordo por um motivo de Propriedade. Qual Campo foi Esquecido no setup do controle?",
        "options": [
            "Success Condition.",
            "Failure Time Field.",
            "Warning Condition Boolean.",
            "SLA Timer Clock UI."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Paridade técnica do Elemento SLA / Temporizador em formulários.",
            "papoReto": "Se você pôs um relógio de Bomba-relógio rodando na tela do cliente (Para meta de SLA), você OBRIGATORIAMENTE tem que dizer pro Relógio que hora a bomba estoura! (O Failure Time Field).",
            "respostaCerta": "Failure Time Field.",
            "puloDoGato": "O Timer Control OOTB de SLA do Case Model-driven demands a explicit DateTime pointer (Failure Time) para basear os recuos em minutos/horas.",
            "cascasDeBanana": [
                "Warning e Success são secundários. Se o Failure não existe, o timer Control quebra."
            ],
            "dicaOuro": "Temporizador de SLA requer = Uma DACA/HORA cravada de Fracasso! (Failure Time Field)."
        }
    },
    {
        "id": "q242_topic1",
        "text": "Para fazer a ingestão diária de planilhas locais para atualizar registros vitais no Dataverse de forma nativa e agendada (Cron job 8h matinal), qual Ferramenta de ETL sem-código faz isso dentro das Solutions da plataforma?",
        "options": [
            "Dataflows.",
            "Azure Logic Apps.",
            "Business Rules de Extração.",
            "Excel Add-in nativo."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Compreensão do uso de Power Query online.",
            "papoReto": "Quer pegar milhares de dados soltos num servidor, limpar as colunas e despejar certinho nas contas do seu CRM num horário automático todo dia sem escrever 1 linha de programação? 'Dataflows' é a picareta oficial de extração em nuvem M365.",
            "respostaCerta": "Dataflows.",
            "puloDoGato": "Os Fluxos de dados (Dataflows) usam a engine amigável do Power Query baseada na Web para Extrair, Transformar e Carregar (ETL) Data periodicamente em tabelas do Dataverse.",
            "cascasDeBanana": [
                "Excel Add-in é para publicações manuais imediatas. Logic Apps demanda infra do Azure."
            ],
            "dicaOuro": "Carga de Dados Programada Online e Mapeada (ETL)? = Usar o Dataflow Maker!"
        }
    },
    {
        "id": "q243_topic1",
        "text": "O recurso 'Formulário de Criação Rápida' (Quick Create Form) facilita inserções velozes no Dynamics. Porém, a aba do topo com o botão '+' ignorou e NÃO exibiu a tabela 'Auditorias Físicas'. O que impede exibição do Quick Create Menu na barra superior?",
        "options": [
            "Faltar Marcar a checkbox 'Ativar formulários de criação rápida' nas opções da Tabela.",
            "O Formulário ter mais de tres Colunas em sua formatação base.",
            "Power Automate bloquear os Hooks On_Create.",
            "Somente App Canvas pode ser usado no Menu Mais (+)."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Conceitos de Model Driven de Habilidade e Metadados.",
            "papoReto": "Se você moldou o Formulário tipo 'Rapinho', mas nunca foi até o chassi principal do motor (Tabela) e marcou a caixinha: 'Ei, a tabela Auditações Físicas suporta criação rápida', M365 se nega a liberar ele pra aparecer lá em cima na fita universal.",
            "respostaCerta": "Faltar Marcar a checkbox 'Ativar formulários de criação rápida'.",
            "puloDoGato": "The Option 'Allow quick create' in Table properties enables the System ribbon to fetch and display the related Entity's Quick form payload list.",
            "cascasDeBanana": [
                "Colunas ou Layout do fomulário não travam a exibição no menu de cima, causariam no máximo uma interface esquisita."
            ],
            "dicaOuro": "Quick Form não aparece de Fato? Confere de novo a Checkbox de Allow Quick Create nos Detalhes da Tabela!"
        }
    },
    {
        "id": "q244_topic1",
        "text": "No desenvolvimento de uma Solution de Power Platform, os Environment Variables (Variáveis de Ambiente) cumprem qual finalidade técnica primária?",
        "options": [
            "Armazenar Links/Connection References pesados que variam por ambiente M365 ao transferir a Solution de DEV para PROD.",
            "Agir como Chave Pix global entre usuários do App Canvas.",
            "Criar regras de RLS dinâmicas automáticas em workspaces híbridos.",
            "Desbloquear telas com IF statements para Vendedores Clássicos."
        ],
        "correctAnswer": 0,
        "explanation": {
            "intro": "Ciclo de vida da Plataforma em ALM Limits.",
            "papoReto": "Quando você manda as Malas (Solução) pro Ambiente de Estágio (QA), você não quer que seu Fluxo de E-mail continue batendo no Banco de Dados Fake do programador. Variável de Ambiente é pra você só botar o link ali, na Exportação M365 limpa, ela desliga os IDs do Local DEV e liga os Links M365 sérios do mundo de PROD oficial.",
            "respostaCerta": "Prover valores que mudam com base no Ambiente (e.g. URLs de endpoints, Client IDs).",
            "puloDoGato": "Environment Variables separate Environment-linked constants from Configuration Code elements enabling robust and dynamic ALM CI/CD.",
            "cascasDeBanana": [
                "As pessoas acham que é variável local de código Canvas para o desenvolvedor, mas afeta configuração sistêmica limit M365 e Flows infra level."
            ],
            "dicaOuro": "Mudar URLs de DEV para Teste de maneira Elegante num pacote = Variáveis de Ambiente."
        }
    },
    {
        "id": "q245_topic1",
        "text": "Um Canvas App armazena coleções offline usando a função SaveData(). Qual a arquitetura na qual este arquivo de salvamento reside fisicamente ao acionarmos a função SaveData no Power Apps Player App Móvel Android?",
        "options": [
            "Cache de Sessão temporária Dataverse limit do Model-Driven Server.",
            "Cache nativo local isolado do Aplicativo M365 no Dispositivo.",
            "Uma pasta acessível no Google Drive root.",
            "Num container Docker efêmero hosteado por Microsoft Azure."
        ],
        "correctAnswer": 1,
        "explanation": {
            "intro": "Controle de Persistência Nativas em Mobile M365.",
            "papoReto": "Quando o Celular do cara cai o acesso do 4G na fazenda e o comando SaveData é lançado pelo Power Apps, a Microsoft arruma um esconderijo muito obscuro, guardado e local do aplicativo em si, na engrenagem C: do telefone dele para não perder a transação local.",
            "respostaCerta": "Cache nativo local isolado do Sistema Mobile.",
            "puloDoGato": "The function creates a local encrypted SQLite instance stored deeply within the Power Apps specific mobile host shell cache footprint. Não é um File solto no Filesystem do celular.",
            "cascasDeBanana": [
                "Achar que há push pro Dataverse ou cloud. A função Offline visa precisamente evitar o push imediato Limit server."
            ],
            "dicaOuro": "SaveData/LoadData operam magicamente no Armazenamento Local e Invisível App-Isolated Edge Storage M365 limite!"
        }
    },
    {
        "id": "q246_topic1",
